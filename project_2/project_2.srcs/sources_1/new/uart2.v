module uart2(
 ...
 input            clk  ,
 input            rst_n ,
 output reg[11:0]x1 =12'b0,x2=12'b0,x3=12'b0,x4=12'b0,y1=12'b0,y2=12'b0,y3=12'b0,y4=12'b0,radius=12'b0,
 output reg[3:0]r=4'b0,g=4'b0,b=4'b0,
 input[18:0] rd_addr,
 output[11:0] rd_data,
 input       uart_rx,//串口信号 接Y19
 output reg [2:0 ]functionChoice = 3'd5 //判断功能的执行模块
 );
 reg [2:0] functionChoice2 = 3'd5;
